...
<input name="questionType" type="hidden" value="MultiMultipleChoiceQuestion"/> 
<div class="panel panel-default">
  <div class="panel-heading"> 
  	<h3 class="panel-title">Add a Multi-Multiple Choice Question</h3>
  </div>
    ...
    <div class="col-lg-6">
        <div class="input-group">
            <span class="input-group-addon">
                <input type="checkbox" name="checkbox0" value="0" />
            </span>
