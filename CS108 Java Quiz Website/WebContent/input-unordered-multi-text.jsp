...
<form role="form" action = "unorderedQuestionServlet" method = "post">
<input name="id" type="hidden" value="<%=id%>"/> 
<!-- ORDERED MULTI-TEXT  --><!-- UNORDERED MULTI-TEXT -->
<div class="panel panel-default">
  <div class="panel-heading"> 
  	<h3 class="panel-title">Add an Unordered Multi-Text Question</h3>
  </div>
...
<div id="questionTable">
    ...
    <div class="col-lg-6">
        ...
        How many answers will there be to this question?
            <input type="text" id="numAnswers" maxlength="10" name="numAnswers" placeholder="Number of answers" />
        </div>
    </div>
	<br>
</div>
