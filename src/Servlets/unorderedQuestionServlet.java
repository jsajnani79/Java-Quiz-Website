...
/**
 * Servlet implementation class unorderedQuestionServlet
 */
@WebServlet("/unorderedQuestionServlet")
public class unorderedQuestionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public unorderedQuestionServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getParameter("numAnswers").equals("")){
			RequestDispatcher dispatch = request.getRequestDispatcher("input-unordered-multi-text.jsp");
		...
		out.println("<!-- UNORDERED MULTI-TEXT -->");
		out.println("<form action=\"AddQuestionToQuiz\" method=\"post\">");
		out.println("<input name=\"id\" type=\"hidden\" value=\""+id+"\"/>");
		out.println("<input name=\"questionType\" type=\"hidden\" value=\"UnorderedMultiTextQuestion\"/>"); 
		out.println("<input name=\"numAnswers\" type=\"hidden\" value=\""+numAnswers+"\"/>");
		out.println("<div class=\"panel panel-default\">");
		out.println("<div class=\"panel-heading\"> ");
		out.println("<h3 class=\"panel-title\">5. Unordered Multi-Text</h3>");
		out.println(" </div>");
		out.println("<div class=\"panel-body\">");
		out.println("<textarea class=\"form-control\" rows=\"2\" maxlength=\"1000\" name=\"questionBackground\" placeholder=\"Add any background info on the question here\"></textarea>");
		out.println("</div>");
		out.println("<div id=\"questionTable\">");
		out.println("<textarea class=\"form-control\" rows=\"3\" maxlength=\"1000\" name=\"questionText\" placeholder=\"Type question text here\"></textarea>");
		out.println("<br>");
